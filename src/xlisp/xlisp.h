/* 12/03/83 added def for Computer Innovations CI C86 compiler */
...
/* for computer innovations CI C86 compiler */
#ifdef cic86
#define DEFEXT
#define KEYMAPCLASS
#define NNODES	200
#define TDEPTH	100
#define kbin() bdos(6,0xff)	/* should read status only */
#define strchr	index		/* Betz said this was because DECUS */
#endif				/* compiler used strchr not index */
